...
export function CredentialsStep({ control }: CredentialsStepProps): React.JSX.Element {
    ...
    return (
        <>
            <FormField control={control} label={t("register.credentials.emailLabel")} name="email">
                {({ value, onChange }) => (
                    <Input
                        autoCapitalize="none"
                        autoComplete="email"
            ...
            <FormField control={control} label={t("register.credentials.passwordLabel")} name="password">
                {({ value, onChange }) => (
                    <PasswordInput
            ...
            <FormField control={control} label={t("register.credentials.confirmPasswordLabel")} name="confirmPassword">
                {({ value, onChange }) => (
                    <PasswordInput
                        autoComplete="new-password"
                        className={REGISTER_INPUT_CLASS}
