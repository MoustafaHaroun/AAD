...
export function AddressStep({ control }: AddressStepProps): React.JSX.Element {
    ...
    return (
        <>
            <FormField control={control} label={t("register.address.countryLabel")} name="country">
                {({ value, onChange }) => (
                    <Input
            ...
            <FormField control={control} label={t("register.address.regionLabel")} name="region">
                {({ value, onChange }) => (
                    <Input
                        className={REGISTER_INPUT_CLASS}
                        onChangeText={onChange}
            ...
            <View className="flex-row gap-3">
                <View className="flex-1">
                    <FormField control={control} label={t("register.address.cityLabel")} name="city">
                        {({ value, onChange }) => (
                            <Input
                                className={REGISTER_INPUT_CLASS}
                                onChangeText={onChange}
                ...
                <View className="flex-1">
                    <FormField control={control} label={t("register.address.postalCodeLabel")} name="postalCode">
                        {({ value, onChange }) => (
                            <Input
                                className={REGISTER_INPUT_CLASS}
                                onChangeText={onChange}
            ...
            <FormField control={control} label={t("register.address.streetLabel")} name="street">
                {({ value, onChange }) => (
                    <Input
                        className={REGISTER_INPUT_CLASS}
                        onChangeText={onChange}
