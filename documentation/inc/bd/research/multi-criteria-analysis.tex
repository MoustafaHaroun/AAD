...
\paragraph{Community}
The official Spring Boot GitHub repository has over 80.000 stars \cite{bib:spring-boot-github}, the official Spring Discord server has over 8.000 members \cite{bib:spring-discord}, and there are at least 400.000 results on GitHub for Spring Boot projects \cite{bib:spring-boot-github-search}.
...
\paragraph{Community}
The official NestJS GitHub repository has over 75.000 stars \cite{bib:nestjs-github}, the official NestJS Discord server has over 30.000 members \cite{bib:nestjs-discord}, and there are at least 80.000 results on GitHub for NestJS projects \cite{bib:nestjs-github-search}.
