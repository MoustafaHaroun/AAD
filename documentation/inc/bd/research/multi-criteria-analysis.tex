...
Spring Boot is an open source Java-based framework developed by Pivotal, built on top of the Spring Framework.
...
\paragraph{Community}
The official Echo GitHub repository has over 30.600 stars \cite{bib:echo-github}, there is no dedicated Echo Discord server but the Golang Discord server has over 42.000 members \cite{bib:golang-discord}, and there are at least 6.500 results on GitHub for Echo projects \cite{bib:echo-github-search}.
...
\begin{htable}[
	...
	Number of stars & 5 & $\bar{x} = \frac{N}{N_{\max}}$ & $\bar{x} = \frac{30600}{30600} = 1$ \\
...
The last major release of the Echo framework was December 19, 2024, which falls within the last six months. \cite{bib:echo-github}
...
\paragraph{Community}
The official Spring Boot GitHub repository has over 75.000 stars \cite{bib:spring-boot-github}, the official Spring Discord server has over 8.000 members \cite{bib:spring-discord}, and there are at least 400.000 results on GitHub for Spring Boot projects \cite{bib:spring-boot-github-search}.
...
\begin{htable}[
	...
	Number of Discord users & 5 & $\bar{x} = \frac{N}{N_{\max}}$ & $\bar{x} = \frac{8000}{44000} = 0.18$ \\
...
The last major release of Spring Boot was within the last six months. \cite{bib:spring-boot-github}
...
\paragraph{Community}
The official NestJS GitHub repository has over 67.000 stars \cite{bib:nestjs-github}, the official NestJS Discord server has over 30.000 members \cite{bib:nestjs-discord}, and there are at least 80.000 results on GitHub for NestJS projects \cite{bib:nestjs-github-search}.
...
\begin{htable}[
	...
	Sub-criterion & Weight & Function & Normalized score \\
	Number of stars & 5 & $\bar{x} = \frac{N}{N_{\max}}$ & $\bar{x} = \frac{67000}{75000} = 0.89$ \\
	Number of Discord users & 5 & $\bar{x} = \frac{N}{N_{\max}}$ & $\bar{x} = \frac{30000}{44000} = 0.68$ \\
...
The last major release of NestJS was within the last six months. \cite{bib:nestjs-github}
