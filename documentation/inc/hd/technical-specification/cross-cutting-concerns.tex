...
Cached listing data and listing details are additionally supported by the local persistence layer, which uses Expo SQLite and Drizzle ORM.
...
Fixed-height text containers are reviewed and adjusted where they can clip or truncate enlarged text.
