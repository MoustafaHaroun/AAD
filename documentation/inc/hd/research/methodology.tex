\section{Methodology}
To select a suitable front-end framework, a literature review and a multi-criteria analysis were conducted.
...
Two frameworks from the analysis were explored further by developing prototypes.
...
A set of criteria was established to evaluate the front-end frameworks.
...
It contains numerous hybrid front-end frameworks.

\begin{itemize}
    \item .NET MAUI (C\#)
    \item Aurelia (JavaScript)
    \item Ext JS (JavaScript)
    \item Flutter (Dart)
    \item Framework7 (JavaScript)
    \item Intel XDK (JavaScript)
    \item Ionic (JavaScript)
    \item jQuery Mobile (JavaScript)
    \item Kendo UI (JavaScript)
    \item Kotlin Multiplatform (Kotlin)
    \item NativeScript (JavaScript)
    \item Onsen UI (JavaScript)
    \item PhoneGap (JavaScript)
    \item Quasar Framework (JavaScript)
    \item React Native (JavaScript)
    \item Sencha Touch (JavaScript)
    \item Titanium SDK (JavaScript)
    \item Xamarin (C\#)
\end{itemize}
...
\paragraph{Flutter}\label{subsubsec:frameworks-flutter}
...
\paragraph{React Native}\label{subsubsec:frameworks-react-native}
...
\paragraph{Ionic}\label{subsubsec:frameworks-ionic}
